## 系统名称 
电商后台库存管理系统系统 warehouse 
### 系统概要
电商后台库存管理系统系统总共分为两个大的模块，分别是系统模块和业务模块。其中系统模块和业务模块底下又有其子模块。
### 功能模块
#### 一、业务模块
##### 1、客户管理
###### 客户列表
...
### 讨论
有问题请在([issue])讨论 或联系我QQ：1582742921，你请注明来意。该项目是开源的，如果clone到本地运行不起来，或者需要我讲解之类的，我可以有偿讲解，伸手党勿加~
